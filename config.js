...
const PROPERTY_CELL ={
  ...
  INSTA_APP_SECRET: 'B8',
  INSTA_USER_ID: 'B9',
  INSTA_BUSINESS_ID: 'B10',
  INSTA_SHORT_ACCESS_TOKEN: 'B11',
  INSTA_LONG_ACCESS_TOKEN: 'B12',
  INSTA_LONG_ACCESS_TOKEN_EXPIRY: 'B13',
  THREADS_LONG_TIME_TOKEN: 'B14',
  THREADS_LONG_TIME_TOKEN_EXPIRY: 'B15',
  THREADS_CLIENT_ID: 'B16',
  THREADS_CLIENT_SECRET: 'B17',
  SELECTED_SHEET_NAME: 'B18',
};
